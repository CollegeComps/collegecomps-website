  ...
  return (
    <div className="mt-4 pt-4 border-t border-gray-200">
      <details className="group">
        ...
        <div className="mt-3 ml-6 space-y-3 text-xs text-gray-300">
          {/* Data Sources */}
          {sources.length > 0 && (
            <div>
              <p className="font-semibold text-gray-300 mb-2">Data Sources:</p>
              <ul className="space-y-1.5 list-disc list-inside">
                {sources.map((source, idx) => (
                  <li key={idx}>
                    ...
                    {source.lastUpdated && (
                      <span className="text-gray-400"> (Updated: {source.lastUpdated})</span>
                    )}
                  </li>
                ))}
              </ul>
          ...
          {assumptions && assumptions.length > 0 && (
            <div>
              <p className="font-semibold text-gray-300 mb-2">Assumptions & Notes:</p>
