...
export function DataSourcesFooter() {
  return (
    <div id="data-sources" className="bg-black border-t border-gray-800 py-12 px-4 sm:px-6 lg:px-8 mt-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {dataSources.map((source, index) => (
            <div
              key={index}
              className="bg-gray-900 border border-gray-800 rounded-xl shadow-[0_0_15px_rgba(249,115,22,0.1)] p-6 hover:-translate-y-1 transition-all duration-300"
            >
              <div className="flex items-start mb-3">
                <div className="flex-shrink-0 w-10 h-10 bg-orange-500/10 rounded-lg flex items-center justify-center border border-orange-500/20">
                ...
                <div className="ml-4 flex-1">
                  ...
                  <a
                    ...
                    className="text-xs text-orange-500 hover:text-orange-600 hover:underline inline-flex items-center"
                  >
                    Visit Source
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          <p>
            <a href="/about/methodology" className="text-orange-500 hover:text-orange-600 hover:underline">
...
export function DataSourcesBadge() {
  return (
    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 border border-gray-800 rounded-lg text-sm shadow-[0_0_10px_rgba(249,115,22,0.08)]">
      <svg className="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
      </svg>
      <span className="text-gray-300">
        Data from <span className="font-semibold text-orange-500">IPEDS</span> & <span className="font-semibold text-orange-500">College Scorecard</span>
      </span>
      <a
        href="/#data-sources"
        className="text-orange-500 hover:text-orange-600 hover:underline font-semibold ml-1"
      >
        Details
      </a>
    </div>
