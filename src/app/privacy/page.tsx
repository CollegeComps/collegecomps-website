      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="prose prose-blue max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mt-3 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded">
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <p className="text-gray-700"><strong>Email:</strong> privacy@collegecomps.com</p>
              <p className="text-gray-700 mt-2"><strong>Mail:</strong> CollegeComps<br/>Privacy Team<br/>[Your Business Address]</p>
              <p className="text-gray-700 mt-2"><strong>Support:</strong> <a href="/support" className="text-blue-600 hover:underline">Contact Support</a></p>
            </div>
          </section>
